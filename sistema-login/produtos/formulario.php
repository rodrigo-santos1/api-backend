            ...
            <div class="col-md">
                ...
                <form id="clientForm" action="/produtos/cadastrar.php" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="produto" name="produto" value="<?php echo isset($produto) ? $produto["produto"] : ""; ?>">
                    </div>
                    <div class="mb-3">
                        <label for="produtoDescription" class="form-label">Descrição</label>
                        <input type="text" class="form-control" id="produtoDescription" name="produtoDescription" value="<?php echo isset($produto) ? $produto["descricao"] : ""; ?>">
                    </div>
                    <div class= "mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control" id="produtoPrice" name="produtoPrice" value="<?php echo isset($produto) ? $produto["preco"] : ""; ?>">
                    </div>   
